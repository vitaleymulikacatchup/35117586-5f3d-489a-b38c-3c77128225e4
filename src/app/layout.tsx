...
export const metadata: Metadata = {
  title: "Galileo IT School - Transform Your Career with Tech Education",
  description: "Join Galileo IT School for comprehensive tech training in web development, data science, UI/UX design, and more. Career placement support included.",
  keywords: "IT school, coding bootcamp, web development, data science, tech career, programming courses",
  metadataBase: new URL("https://galileo-it-school.com"),
  alternates: {
    canonical: "https://galileo-it-school.com"
  },
  openGraph: {
    title: "Galileo IT School - Transform Your Career with Tech Education",
    description: "Master programming, web development, data science, and cloud technologies with industry experts. Career placement support included.",
    url: "https://galileo-it-school.com",
    siteName: "Galileo IT School",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763718297307-excvbv1j.jpg",
      alt: "Galileo IT School students learning technology"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Galileo IT School - Transform Your Career with Tech Education",
    description: "Master programming, web development, data science, and cloud technologies with industry experts. Career placement support included.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763718297307-excvbv1j.jpg"]
  },
  robots: {
    index: true,
    follow: true
